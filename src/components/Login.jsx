...
//     e.preventDefault();
//     const response = await axios.post("https://gemlog-backend.onrender.com/user/login", {
//       email,
//       password,
//     });
...
//           <button
//             type="submit"
//             className="mt-6 w-full bg-purple-500 hover:bg-purple-600 text-white font-semibold py-3 rounded-md transition duration-300"
//           >
//             Login
//           </button>
